...
int GuardedMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow )
{
	...
	LoadString(hInstance, IDC_APPGUIDOCK, szWindowClass, MAX_LOADSTRING);
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_APPGUIDOCK));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_APPGUIDOCK);
	wcex.lpszClassName	= szWindowClass;
	wcex.hIconSm		= LoadIcon(wcex.hInstance, MAKEINTRESOURCE(IDI_APPGUIDOCK));
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_APPGUIDOCK));
