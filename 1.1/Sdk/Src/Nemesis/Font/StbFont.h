...
namespace nemesis { namespace font
{
	...
	{
	public:
		static Result_t CreateInstance( Allocator_t alloc, const StbFontSetup_s& setup, Font_t* font );

	private:
		static Result_t GetTextMetric( Font_t font, TextMetrics_s& tm );
		static Result_t GetGlyphInfos( Font_t font, const wchar_t* t, int num_chars, GlyphInfo_s* infos );
